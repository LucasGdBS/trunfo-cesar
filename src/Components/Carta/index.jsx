...
const Carta = ({ destinatario, texto }) => {
  return (
    <div className="flex flex-col items-center justify-center h-full min-h-screen bg-gradient-to-r from-green-400 to-green-600 rounded-3xl p-4 sm:min-h-[calc(100vh-7rem)] select-none">
