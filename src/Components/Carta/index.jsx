...
const Carta = ({ destinatario, texto, className }) => {
  return (
    <div className={classNames("flex flex-col items-center justify-center w-full h-full min-h-screen bg-gradient-to-br from-slate-600 to-slate-950 rounded-3xl p-4 sm:min-h-[calc(100vh-7rem)] select-none", className)}>
      {destinatario && (
